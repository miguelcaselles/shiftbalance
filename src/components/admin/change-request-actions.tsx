...
export function ChangeRequestActions({ requestId, currentStatus }: ChangeRequestActionsProps) {
  ...
  const handleApprove = async () => {
    setIsLoading(true)
    try {
      const response = await fetch(`/api/admin/changes/${requestId}/approve`, {
        method: "POST",
      ...
      toast({
        ...
        description: "La solicitud de cambio ha sido aprobada",
      })
  ...
  const handleReject = async () => {
    setIsLoading(true)
    try {
      const response = await fetch(`/api/admin/changes/${requestId}/reject`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
